---You can copy the code as it is in your configuration, also I would like
---to credit the inspiration for writing this to https://github.com/tjdevries,
---as this is more or less similar to his vlog.nvim on github.
---
---I would recommend people to use that instead of this for more perfect
---implementation.
---
---
---Log module which enables logging as per minimal configuration.
---
---Usage:
---local log = require("llogger").setup{ name = "SomeNamePrintedInLogs", level = "info" }
---log.info("This is a test message for logging")
---log.error("Something went wrong while running program")
---
---Arguments interpolation:
---log.error("Something went wrong at line <> with msg <>", 32, "some message")
local this = {
...
---Initialises the module with passed table.
---
--`@param config - table see the default for more details`
